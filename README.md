...
## Overview
In this project you will use CO2 sensors to measure indoor climate.
...
If you use prompts, document which code is [based on](https://github.com/fhnw-imvs/fhnw-ipro-indoor-climate/blob/main/level-1/Python/csv_write/csv_write.py#L2) which [prompt](https://github.com/fhnw-imvs/fhnw-ipro-indoor-climate/blob/main/prompts/duck.ai_2025-08-29_11-41-09.txt).

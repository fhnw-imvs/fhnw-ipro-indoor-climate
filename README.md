...
If you use prompts, save them, e.g. for code [based on](https://github.com/fhnw-imvs/fhnw-ipro-indoor-climate/blob/main/level-1/Python/csv_write/csv_write.py#L2) a [prompt](https://github.com/fhnw-imvs/fhnw-ipro-indoor-climate/blob/main/prompts/duck.ai_2025-08-29_11-41-09.txt).

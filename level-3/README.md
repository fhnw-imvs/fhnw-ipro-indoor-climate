...
- [ ] Add a real-time line chart to the web dashboard
- [ ] Test alternative cloud services
- [ ] Adapt the web interface for smartphone viewing and interaction
- [ ] Measure battery life for the setup and optimize for energy efficiency
- [ ] ...

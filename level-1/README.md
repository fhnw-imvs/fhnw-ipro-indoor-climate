...
#### With MakeCode
Open _Extensions_, search for a library, e.g. [Grove](https://makecode.microbit.org/v1/pkg/Seeed-Studio/pxt-grove), click to add it, then check for new blocks matching the sensor name, e.g. SCD30.
